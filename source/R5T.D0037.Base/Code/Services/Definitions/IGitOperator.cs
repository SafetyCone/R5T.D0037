...
namespace R5T.D0037
{
    public interface IGitOperator
    {
        ...
        /// </summary>
        Task<bool> HasUnpulledOriginMasterChanges(LocalRepositoryDirectoryPath repositoryDirectoryPath);

        /// <summary>
        /// Gets the origin repository URL for a file or directory path within a local repository.
        /// </summary>
        Task<RemoteRepositoryUrl> GetOriginRepositoryUrlAsync(LocalRepositoryContainedPath path);
